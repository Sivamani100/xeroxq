                    ...
                    <div className="flex flex-col gap-8">
                      ...
                      <div className="pt-6 border-t border-gray-100 flex flex-col gap-4">
                        <Button
                          ...
                          className="h-14 rounded-2xl w-full bg-[#FB432C] hover:bg-black text-white font-bold text-lg shadow-xl shadow-brand-primary/20 transition-all duration-300 flex items-center justify-center gap-2">
              ...
              <div className="hidden lg:flex items-center gap-6">
                <div className="flex items-center gap-3">
                  <Button
                    ...
                    className="h-10 rounded-full px-6 text-sm bg-[#FB432C] hover:bg-black text-white font-medium shadow-xl shadow-brand-primary/20 transition-all duration-300 active:scale-95 flex items-center gap-2">
